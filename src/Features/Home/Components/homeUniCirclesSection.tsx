...
import { FaAtom, FaBrain, FaBuildingColumns, FaFlaskVial, FaGlobe, FaGraduationCap, FaInfinity , FaNetworkWired, 
            FaPersonChalkboard, FaSchoolFlag, FaTablets, FaVideo, FaStudiovinari } from "react-icons/fa6";


export default function HomeUniCirclesSection(){
    ...
    return(
        ...
        <section className="p-16 py-24 relative circle-uni-section  @container mx-auto   secondary-bg">
            ...
            <div className="circle-uni-section-container grid grid-cols-6 main-container-styles">
                    ...
                    <div className={'circleSection col-span-4 md:col-span-3 pt-50 md:py-0'} >
