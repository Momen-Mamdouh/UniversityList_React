...
import StudentImageDiv from "@/src/Components/studentImageDiv";
import { IIconWithText } from "@/src/Interfaces/IIconWithText";
import uniLecturerImage from '@/src/assets/University/lecturer.png';
import uniStudentImage from '@/src/assets/University/newStudent.png';
import { FaCheck, FaGlobe, FaPaperPlane, FaWallet } from "react-icons/fa6";



export default function HomeStudentSection(){
        ...
        <section className="p-16  students-section secondary-bg  @container mx-auto ">
            <div className="student-section-container main-container-styles">
                    ...
                    <div className="student-classes pt-24 grid grid-cols-6 gap-10">
                        ...
                        <div className="student-image col-span-6 md:col-span-3">
                        <div className={'studentClassesSection col-span-6 md:col-span-3'} >
                    ...
                    <div className="student-courses pt-32 grid grid-cols-6 gap-10">
                        ...
                        <div className={'studentCoursesSection col-span-6 md:col-span-3'} >
